  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CartBloc, CartState>(
      ...
      builder: (context, state) {
        // Show all items in Cart Summary: Active, Pending, Cancelled, New
        final cartItems = state.items;

        final totalAmount = state.activeOrderTotalAmount + state.pendingOrderTotalAmount + state.newOrderTotalAmount;
